"""Google Generative AI (Gemini via API key) provider implementation."""
...
def stream_google(
    ...
    """Stream a response from Google Generative AI."""
...
def _create_client(model: Model, api_key: str, options_headers: dict[str, str] | None = None) -> Any:
    from google import genai
...
def _build_params(model: Model, context: Context, options: GoogleOptions | None = None) -> dict[str, Any]:
